...
namespace ChapeauUI
{
    public partial class orderingForm : Form
    {
        ...
        {
            cmbOrderingCategory.Items.AddRange(Enum.GetNames(typeof(ItemCategory)));
        }
        ...
        private void btnOrderingLunch_Click_1(object sender, EventArgs e)
        {
            FilterMenuItems(MenuType.Lunch);
        }
        ...
        private void cmbOrderingCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            myOrderForm myOrderForm = new myOrderForm(userOrder);
            myOrderForm.Show();
        }
